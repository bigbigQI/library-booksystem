...
<body>
	...
	<table class="table table-striped table-bordered table-hover datatable">
		<tr>
			...
			<td width="100" align="center" bgcolor="#cd853f">年级</td>
			<td width="100" align="center" bgcolor="#cd853f">身份证号</td>
			<td width="100" align="center" bgcolor="#cd853f">电话号码</td>
		...
		<c:forEach items="${users }" var="users">
			<tr>
				...
				<td height="30" align="center" class="l_table_1">${users.grade }</td>
				<td height="30" align="center" class="l_table_1">${users.code }</td>
				<td height="30" align="center" class="l_table_1">${users.phone }</td>
...
<script type="text/javascript">
	function changePage() {
		...
		$.post("${pageContext.request.contextPath}/user/getUserSelect.do?page=" + goalPage, function(data) {
			$("#text").html(data);
	...
	$("#previousPage").click(function() {
		...
		alert(previousPage);
		$.post("${pageContext.request.contextPath}/user/getUserSelect.do?page=" + previousPage, function(data) {
			$("#text").html(data);
			//得到select的option集合
			var list = document.getElementById("pageNum").options;
			//得到select中，上一页的option
	...
	$("#nextPage").click(function() {
		...
		$.post("${pageContext.request.contextPath}/user/getUserSelect.do?page=" + nextPage, function(data) {
			$("#text").html(data);
			//得到select的option集合
			var list = document.getElementById("pageNum").options;
			//得到select中，上一页的option
