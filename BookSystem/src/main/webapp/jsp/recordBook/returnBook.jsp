...
<body>
	...
	<table class="table table-striped table-bordered table-hover datatable">
		<tr>
			...
			<td width="20%" align="center" bgcolor="#cd853f">借书时间</td>

			<td width="10%" align="center" bgcolor="#cd853f">借书人</td>
			<td width="10%" align="center" bgcolor="#cd853f">操作</td>
		</tr>
		...
		<c:forEach items="${records }" var="record">
			<tr>
				...
				<td height="30" align="center" class="l_table_1">${sessionScope.FRONT_USER_SESSION.name }</td>
				<td height="30" align="center" class="l_table_1"><a style="color:#f08080" 
					href="javascript:updateBook('${record.id }')"><u><strong>还书</strong></u></a></td>
			</tr>
		</c:forEach>
	</table>
	<div>
...
<script type="text/javascript">
	function changePage() {
		...
		$.post("${pageContext.request.contextPath}/record/toReturnBook.do?page=" + goalPage, function(data) {
			$("#text").html(data);
	...
	$("#previousPage").click(function() {
		...
		$.post("${pageContext.request.contextPath}/record/toReturnBook.do?page=" + previousPage, function(data) {
			$("#text").html(data);
			//得到select的option集合
			var list = document.getElementById("pageNum").options;
			//得到select中，上一页的option
	...
	$("#nextPage").click(function() {
		...
		$.post("${pageContext.request.contextPath}/record/toReturnBook.do?page=" + nextPage, function(data) {
			$("#text").html(data);
			//得到select的option集合
			var list = document.getElementById("pageNum").options;
			//得到select中，上一页的option
	...
	function updateBook(id) {
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/record/returnBook.do",
